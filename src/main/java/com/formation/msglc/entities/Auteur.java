...
public class Auteur {
	...
	@ManyToMany
	@JoinTable(name = "SujetSuivi", joinColumns = @JoinColumn(name = "idAteur"), inverseJoinColumns = @JoinColumn(name = "idSujet"))
	...
	public Auteur(String email, String nom, String prenom, String password, Date dateNaissance, String pays, Sexe sexe,
			AuteurRole role) {
		super();
		this.email = email;
		this.nom = nom;
